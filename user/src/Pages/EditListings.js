...
const EditListing = () => {
  const { state } = useLocation();
    ...
    const [formData, setFormData] = useState({
      ...
      mapUrl: listing?.mapUrl || 'https://maps.app.goo.gl/UVK53SUQ8xjWia9Y8',
      youtubeUrl: listing?.mapUrl || 'https://www.youtube.com',
      description: listing?.description || 'Pet shop in erode',
      photos: [pet, pet] ,
      pageTitle : "Erode Pet Shop",
      pageKeyword : "Pets, Pet Shop",
      pageDescription : "Located on Erode"
    });
        ...
        <div className='form-container'>
          <Form onSubmit={handleSubmit}>            
            <Form.Group className="mb-3">
              ...
              {formData.mapUrl && (
              <div className="mb-3">
                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d62589.38927838923!2d77.71539695!3d11.346626149999999!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3ba96f46762f4671%3A0xd97da6e3d9c7f75e!2sErode%2C%20Tamil%20Nadu!5e0!3m2!1sen!2sin!4v1756097202579!5m2!1sen!2sin" width="600" height="450" style={{"border":"0"}} allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade" title="Map Url" ></iframe>
              ...
              {formData.youtubeUrl && (
              <div className="mb-3">
                <iframe width="560" height="315" src="https://www.youtube.com/embed/JLnycPtolfw?si=f8oRmxlxuiSXSsmK" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
              ...
              <Form.Group className='mb-4'>
                  ...
                  <Form.Control type='text' name='metaName' value={formData.pageTitle} required onChange={handleChange} />
              </Form.Group>
              <Form.Group className='mb-4'>
                  <Form.Label>Meta Keyword</Form.Label>
                  <Form.Control type='text' name='metaWord' value={formData.pageKeyword} required onChange={handleChange} />
              </Form.Group>
              <Form.Group className='mb-4'>
