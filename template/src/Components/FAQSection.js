...
const FAQSection = ({faqs, showViewAll = true }) => {
  ...
  return (
    <section className="faq-section bg-body-secondary">
      ...
      <div className="faq-footer">
        {/* <button className="view-all-faq-btn" onClick={() => navigate("/faq")} >View All FAQs</button> */}
        {showViewAll && (
        <div className="faq-footer">
          <button
