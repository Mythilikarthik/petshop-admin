  ...
  return (
    <>
      ...
      <Modal 
        ...
        backdrop="static"
      >
        <Modal.Body className="p-5 bg-white position-relative" style={{ borderRadius: '16px' }}>
          ...
          <div className="text-center mb-4">
            <div className="thankyou-title-wrapper">
              <h2 className="fw-bold text-dark m-0">Thank you for registering!</h2>
            </div>
            <p className="text-muted mt-2 mx-auto" style={{ maxWidth: '480px', fontSize: '0.95rem' }}>
              Your account has been created successfully. We will <br /> review and approve your account.
            </p>
          </div>

          {/* 3. Horizontal 4-Step Process Section */}
          <div className="steps-container d-flex align-items-start justify-content-between my-5">
            
            {/* Step 1 */}
            <div className="step-item">
              <div className="step-icon-circle" style={{ backgroundColor: '#eff6ff', color: '#2563eb' }}>
                <BsFileEarmarkCheck size={50} />
              </div>
          ...
          <div className="next-steps-banner p-4 mb-4">
