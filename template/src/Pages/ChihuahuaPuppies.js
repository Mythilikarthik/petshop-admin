...
export default function ChihuahuaPuppies() {
    ...
    return (
      <Container className="py-5 text-center">
        <Card className="p-5 border-0 shadow-sm rounded-4">
          ...
          <p className="mb-0">We couldn't find any chihuahua puppies data for "{areaName}".</p>
        </Card>
      </Container>
    );
  }
        ...
        <Row className="mb-3">
          <Col lg={12}>
            <Breadcrumb className="custom-breadcrumb">
              ...
              <Breadcrumb.Item linkAs={Link} linkProps={{ to: '/chihuahua-puppies-for-sale' }}>
